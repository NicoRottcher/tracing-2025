    ...
    for index, row in exp_icpms.iterrows():
        ...
        if row.t_start__timestamp_icpms_pc != timestamp_csv:
            ...
            print(
                ...
                "\n   from csv: ",
                timestamp_csv, 'type: ', type(timestamp_csv),
                "\n   from AcqData/sample_info.xml",
                row.t_start__timestamp_icpms_pc, 'type: ', type(row.t_start__timestamp_icpms_pc),
...
def check_Agilent_data_csv(file_path):
    ...
    if file_lines[1].split(",")[1].strip("\n") == "CPS":
        raise Exception(
            ...
            "Problem found in file "+str(file_path)
        )
    return True
